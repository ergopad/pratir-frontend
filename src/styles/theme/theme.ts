...
export const optiedMedium = localFont({
  src: "fonts/optiedwallian-medium.otf",
  preload: true,
});
      ...
      styleOverrides: {
        root: {
          ...
          "&:before": {
            ...
            zIndex: 10,
            background:
              "linear-gradient(to right,#a99151 22%,#877036 24%,#ffffcf 26%,#d0b46c 27%,#f2d68d 40%,#a49053 78%)",
            padding: "2px",
            content: '""',
            position: "absolute",
            top: 0,
